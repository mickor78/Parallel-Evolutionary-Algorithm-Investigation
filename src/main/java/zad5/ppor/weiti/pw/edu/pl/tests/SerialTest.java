...
public class SerialTest {
    ...
    @Warmup(iterations = 1, time = 1)
    @Measurement(iterations = 4)
    public static void test_threads2(BeforeState state, Blackhole blackhole) {
        state.mu_lambda.findBestGenotype(state.population);
    }
    ...
    @Warmup(iterations = 1, time = 1)
    @Measurement(iterations = 4)
    public static void test_threads24(BeforeState state, Blackhole blackhole) {
        state.mu_lambda.findBestGenotype(state.population);
    }
    ...
    @Warmup(iterations = 1, time = 1)
    @Measurement(iterations = 4)
    public static void test_threads_max(BeforeState state, Blackhole blackhole) {
        state.mu_lambda.findBestGenotype(state.population);
    }

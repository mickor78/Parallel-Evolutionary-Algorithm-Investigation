package zad5.ppor.weiti.pw.edu.pl.algorithm.Griewank;
...
public class GriewankEvolutionaryAlgorithmFewPopulationTest {
    ...
    public GriewankEvolutionaryAlgorithmFewPopulationTest(int numberOfThreedToForkForAlgOperations, int numberOfThreedAimingByPopulations, int numOfDivide, Population x) {
    ...
    public void init() {
        executionTime = 30;
        function = new GriewankFunctionGPU();
    }
